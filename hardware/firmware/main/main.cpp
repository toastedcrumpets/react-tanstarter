...
#define EXAMPLE_PIN_NUM_SCLK           GPIO_NUM_4
#define EXAMPLE_PIN_NUM_MOSI           -1
#define EXAMPLE_PIN_NUM_MISO           GPIO_NUM_5
...
#define TEST_PIN_NUM_LCD_PCLK       ()
#define TEST_PIN_NUM_LCD_DATA0      ()
